! function(e) {
                ...
                init: function(e) {
                    if (!s) {
                        var t = e.sign || "",
                            ...
                            f = !0 === e.nofixed,
                            p = r + "?inner=1&sign=" + t + "&uid=" + o + "&rmb=" + l + "&goodImg=" + u;
                        if (n && Object.keys(n).length) p += "&c1=" + (n.c1 || ""), p += "&c2=" + (n.c2 || ""), p += "&c3=" + (n.c3 || ""), p += "&c4=" + (n.c4 || ""), p += "&c5=" + (n.c5 || "");
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            h = (h = h.replace(new RegExp(u, "g"), o.default.scope)).replace(new RegExp("https://kf.qq.com/xv-dev/web", "g"), t);
            var x = document.createElement("div");
            x.innerHTML = h, x.style.display = "none", document.body.appendChild(x);
            var b = function() {
            ...
            if (n) try {
                ...
                F && (p = !1, I = F, w.remove(), clearTimeout(g), g = null, b())
            } catch (Y) {
                console.error(Y)
            }
            p && (0, d.loadTheme)(t, s, function(e, t) {
                var n = !1;
                if (e && t && 0 == t.status) {
                    var i = null;
                    try {
                    ...
                    if (i && i.custom_color) {
                        ...
                        console.log(2222, e, t, i, c), c && (c.style.backgroundColor = a, c.parentNode && c.parentNode.parentNode && (c.parentNode.parentNode.style.display = "block"))
                    } else n = !0
                } else n = !0;
                clearTimeout(g), g = null, n && b(), (0, r.showElem)(w)
            });
            I.addEventListener("click", function() {
                l || (l = !0, E.src = e, E.onload = function() {
                    E.contentWindow.postMessage({
                        type: "init"
                    }, "*")
                }), (0, r.showElem)(y), p && ((0, r.hideElem)(I), (0, r.hideElem)(_), (0, r.hideElem)(v))
            }), a.default.listen(I, c, p), p && (window.onresize = m, m())
        }, t.close = function() {
        ...
        function m() {
            var e = (0, r.getElem)(o.default.chatBtnId).getElementsByClassName("txt")[0],
                t = window.innerWidth;
            e.textContent = t >= 1e3 ? "联系博主" : "博主"
        }
    },
    function(e, t, n) {
        var i = n(7);
    ...
    function(e, t, n) {
        "use strict";
        (function(t) {
            var n = "undefined" !== typeof self ? self : "undefined" !== typeof window ? window : "undefined" !== typeof t ? t : {},
                i = Object.create(n),
                o = /["&'<>]/;
            i.$escape = function(e) {
                return function(e) {
        ...
        t.default = {
            listen: function(e, t, n) {
                window.addEventListener("message", function(o) {
                    ...
                    if (d) {
                        if ("newmsg" == d) n && (c ? (0, a.showElem)(l) : (0, a.showElem)(u));
                        else if ("close" == d)(0, a.hideElem)(s), n && ((0, a.hideElem)(l), (0, a.hideElem)(u), (0, a.showElem)(e));
                        else if ("error" == d);
                        else if ("channel_info" == d) {
                            var f = r.data;
                            if (n && f && f.h5_theme_css) try {
                                var p = JSON.parse(f.h5_theme_css);
                                if (p) {
                                    var m = p.custom_color,
                                        h = (0, a.getElem)(i.default.chatBtnId);
                                    h && (h.style.backgroundColor = m, h.parentNode && h.parentNode.parentNode && (h.parentNode.parentNode.style.display = "block"))
                                }
                            } catch (o) {}
                        }! function(e, t, n) {
    ...
    function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            n.timeout = 3e3, n.onload = function() {
